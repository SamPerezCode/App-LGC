...
const Header: FC<HeaderProps> = ({ user, isDark, activeSection, onToggleTheme, onLogout }) => {
    ...
    >
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-full border border-lgc-border bg-lgc-surface hover:bg-lgc-surfaceMuted dark:border-lgc-darkBorder dark:bg-lgc-darkSurface dark:hover:bg-lgc-darkSurfaceMuted transition-colors"
